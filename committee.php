                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 g-lg-5">
                    <div class="col">
                        <div class="card h-100 doctorimg border-0 customshadow customcard">
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <img src="imgs/committee/dr-rajesh-swarnakar.jpg" width="200"
                                        class="mb-4 doctorImgs" alt="">
                                </div>
                                <h5 class="bluetext text-center fw-bold">Dr. Rajesh Swarnkar</h5>
                                <p class="lightbluetext text-center mb-0">President (2023-2024)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 g-lg-5">
                    ...
                    <div class="col">
                        <div class="card h-100 doctorimg border-0 customshadow customcard">
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <img src="imgs/committee/dr-prerana-garg.jpg" width="200" class="mb-4 doctorImgs"
                                        alt="">
                                </div>
                                <h5 class="bluetext text-center fw-bold">Dr. Prerana Garg</h5>
                                <p class="lightbluetext text-center mb-0">Australia</p>
                            </div>
                        </div>
                    </div>
